...
exports.run = async (client, message, args) => { 
        ...
        if(target.id === message.author.id) message.reply('Why you want to ban yourself?!', { allowedMentions: { repliedUser: false } });
        if(target.id === client.user.id) message.reply('How dare you!', { allowedMentions: { repliedUser: false } });
        if(target.roles.cache.has("742803994816020503")) message.reply("No banning mods please")});
        if(target.roles.cache.has("950383380334260285")) message.reply("No banning trial mods please")});
